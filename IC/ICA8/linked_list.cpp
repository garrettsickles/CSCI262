...
void linked_list::insert_at_head(char d) {
	_head = new node(d, _head);
	if (_tail == NULL) _tail = _head;
	_size++;
}

void linked_list::insert_at_tail(char d) {
...
void linked_list::insert(char d, int position) {
...
char linked_list::get(int position) {
